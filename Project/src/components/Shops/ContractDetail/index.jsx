...
export default function ContractDetail() {
  ...
  return (
    <div>
      <NavBar onBack={back} 
      style={{'--border-bottom':'1px #eee solid'}}>预付卡合同详情</NavBar>
      <AutoCenter><span style={{fontSize:'x-large',fontWeight:'bold',margin:'5px'}}>行业预付式合同（范本）</span></AutoCenter>
      <Form requiredMarkStyle='asterisk' 
      footer={
        <Button block type='submit' color='primary' size='large'onClick={handleClick}>
            提交
          </Button>
      }>
        ...
        <Form.Item name='shopScale'label='使用门店范围'rules={[{required:true}]}>
            ...
            <Checkbox value='2'>各连锁门店可用</Checkbox>
        </Form.Item>
        ...
        <Form.Header>第三条 重要事项及告知方式</Form.Header>
            ...
            <Form.Item name='otherItems'rules={[{required:true}]}>
              <TextArea placeholder='请输入您与商家协商的其他条款' autoSize={{minRows:3,maxRows:5}}></TextArea>
            </Form.Item>
            ...
            <Form.Item name='consumerSign'label='甲方签名' rules={[{required:true}]}>
              <Input placeholder='请提供有公信力的第三方电子签名'/>
            </Form.Item>
